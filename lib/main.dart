            ...
            switch (settings.name) {
              case '/':
                return MaterialPageRoute(
                  builder:
                      (_) => DashboardScreen(onTabSelected: (int index) {}),
                );
              case '/message_screen':
                return MaterialPageRoute(
                  builder: (_) => MessagesScreen(onTabSelected: (int index) {}),
                );
              case '/ocr_medicine_scanner':
                return MaterialPageRoute(
                  builder:
                      (_) => OcrMedicineScanner(onTabSelected: (int index) {}),
                );
              case '/schedule_scanner':
                return MaterialPageRoute(
                  builder: (_) => ScheduleScreen(onTabSelected: (int index) {}),
                );
              case '/User_screen':
                return MaterialPageRoute(
                  builder:
                      (_) =>
                          UserManagementScreen(onTabSelected: (int index) {}),
                );
              case '/settings':
              ...
              case '/qr':
                return MaterialPageRoute(
                  builder: (_) => const ModernQRScanner(),
                );
              case '/accepted':
                final args = settings.arguments;
                if (args is Map<String, dynamic> &&
                    args['parsedRequests'] is List<Map<String, String>>) {
                  final parsedRequests =
                      args['parsedRequests'] as List<Map<String, String>>;
                  return MaterialPageRoute(
                    builder: (_) => AcceptedScreen(token: ''),
                  );
                } else {
                  return _errorRoute(
                    "Missing or invalid arguments for AcceptedScreen",
                  );
                }
              default:
